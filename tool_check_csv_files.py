...
class AssignArkidTool(object):
    ...
    def getParameterInfo(self):
        ...
        csv_path_param = arcpy.Parameter(
            displayName="CSV files located at",
            name="To Directory",
            datatype="GPString",
            direction="Output"
    ...
    def updateParameters(self, parameters):
        ...
        if (workspace_directory.source_batch_directory_path is not None):
            csv_files_directory_path = workspace_directory.csv_files_arkid_directory_path
        ...
        parameters[2].value = csv_files_directory_path
        return
