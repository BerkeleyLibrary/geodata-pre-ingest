...
class BatchCreateGeoblacklightTool(object):
    ...
    def getParameterInfo(self):
        ...
        return [ source_batch_directory_path_param, projected_batch_directory_path, main_csv_arkid_filepath_param, 
                resp_csv_arkid_filepath_param, result_directory_path_param]
    ...
    def execute(self, parameters, messages):
        try:
            common_helper.verify_selected_source_batch_directory(parameters, 5)
