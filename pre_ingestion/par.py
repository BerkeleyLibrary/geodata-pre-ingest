...
INCORRECT_ROLE_FOR_INDIVIDUAL = '*** "{0}" - In ResponsibleParty CSV file, role "{1}" should not have individual. Only role 6 could have individual'

MISSING_ROLE =  '*** Responsible party, "{0}" - missing "{1}" role'

EMPTY_ROLE =  '*** arkid - {0}: Requred role {1} has no value'
