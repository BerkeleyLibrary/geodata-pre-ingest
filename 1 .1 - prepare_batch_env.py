...
process_path = os.getenv("p_path")

# 1. Please provide your local log file path
logfile = fr"{process_path}\log\process.log"
logging.basicConfig(
    filename=logfile,
    level=logging.INFO,
...
source_batch_directory_path = fr"{process_path}\source_batch"

# 3. Please provide projected data directory path
projected_batch_directory_path = fr"{process_path}\source_batch_projected"
